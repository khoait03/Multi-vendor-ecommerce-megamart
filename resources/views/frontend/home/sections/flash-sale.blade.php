                ...
                @if (checkDiscount($product))
                    <div class="col-xl-3 col-sm-6 col-lg-4">
                        <div class="wsus__product_item">
                            ...
                            @if (checkDiscount($product))
                                <div class="mb-3">
                                    <h6 class="text-danger mb-2" style="margin-left: 15px">Giảm giá kết thúc sau :</h6>
                                    <div class="simply-countdown simply-countdown-mini-2 simply-countdown-mini-2-{{ $product->id }}"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            @foreach ($products as $product)
                simplyCountdown(".simply-countdown-mini-2-{{ $product->id }}", {
