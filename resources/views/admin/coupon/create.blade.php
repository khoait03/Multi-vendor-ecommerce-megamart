                                    ...
                                    <form action="{{ route('admin.coupons.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                placeholder="Ví dụ: Giảm giá 50%,..." value="{{ old('name') }}">
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="code"
                                                placeholder="Ví dụ: SALE50,..." value="{{ old('code') }}">
                                            @if ($errors->has('code'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="quantity"
                                                placeholder="Ví dụ: 100,200,..." value="{{ old('quantity') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="max_use"
                                                placeholder="Ví dụ: 1,2,..." value="{{ old('max_use') }}">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="discount"
                                                        placeholder="Ví dụ: 100,200,..." value="{{ old('discount') }}">
