...
<div class="tab-pane fade" id="list-weekly-best-rated" role="tabpanel" aria-labelledby="list-weekly-best-rated-list">
    <div class="card">
        <div class="card-body border">
            <form action="{{ route('admin.weekly-best-rated') }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_slider_1" id="" class="form-control main-category">
                                ...
                                @foreach ($categories as $category)
                                    <option {{ $weeklyBestRated->category == $category->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="sub_category_slider_1" id="" class="form-control sub-category">
                                ...
                                @foreach ($subCategories0 as $subCategory)
                                    <option {{ $weeklyBestRated->sub_category == $subCategory->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="child_category_slider_1" id="" class="form-control child-category">
                                ...
                                @foreach ($childCategories0 as $childCategory)
                                    <option
                                        {{ $weeklyBestRated->child_category == $childCategory->id ? 'selected' : '' }}
