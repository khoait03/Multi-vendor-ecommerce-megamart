    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Điều khoản gian hàng</a></div>
            </div>
        </div>
        ...
        <div class="section-body">
            <a href="{{ route('admin.sub-category.index') }}">
                < Quay lại</a>
                    <h2 class="section-title">Điều khoản gian hàng</h2>
                    <p class="section-lead">Tuỳ chỉnh điều khoản để trở thành gian hàng.</p>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.vendor-condition.update') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" id="" class="editor">{{ @$condition->content }}</textarea>
