    ...
    <div class="row">
        <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
            <div class="dashboard_content mt-2 mt-md-0">
                ...
                <h3><i class="far fa-pen"></i> Chỉnh sửa thành phần của biến thể <u
                ...
                <div class="wsus__dashboard_profile">
                    <div class="wsus__dash_pro_area">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body">
                                <form action="{{ route('vendor.product-variant-item.update', $variantItem->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="is_default" id="" class="form-control">
                                            ...
                                            <option {{ $variantItem->is_default == 0 ? 'selected' : '' }} value="0">
                                                Không
                                            </option>
                                        </select>
