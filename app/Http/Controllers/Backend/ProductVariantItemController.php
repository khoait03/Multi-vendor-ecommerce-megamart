...
class ProductVariantItemController extends Controller
{
  public function index(Request $request)
  {
    ...
    return view('admin.product.product-variant-item.index', compact("variant", "product", "variantItems"));
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route("admin.product-variant-item.index", ["product" => $variant->product_id, "variant" => $variant->id]);
  }
  ...
  public function edit(Request $request)
  {
    ...
    return view('admin.product.product-variant-item.edit', compact("variant", "product", "variantItem"));
  }
